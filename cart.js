              ...
              <div class="purchase-history-section">
                ...
                <div id="purchaseHistoryList" class="purchase-history-list">
                  <div style="text-align: center; padding: 2rem 0;">
                    <svg class="logo-loader" viewBox="0 0 1200 1200" fill="none" xmlns="http://www.w3.org/2000/svg" style="width: 32px; height: 32px; margin: 0 auto 0.6rem;">
                      <path d="M428.393 458.741C397.367 442.352 389.639 455.699 350.257 463.372C297.897 480.729 273.085 493.192 219.832 520.489L270.021 623.63C288.39 656.569 303.786 659.091 332.525 683.826C379.073 693.884 408.435 692.732 468.538 674.586L591.894 632.338L521.57 537.477L428.393 458.741Z" fill="currentColor"/>
                      <path d="M573.217 875.61C558.753 907.579 544.465 901.772 508.648 919.854C456.64 938.242 429.398 943.607 370.592 954.689L347.01 842.436C341.328 805.152 351.945 793.721 359.486 756.56C390.094 720.077 413.996 702.986 472.604 680.474L595.96 638.226L598.559 756.283L573.217 875.61Z" fill="currentColor"/>
                      <path d="M838.875 684.401C873.212 680.144 872.05 664.541 899.764 635.376C932.621 590.63 945.829 565.89 973.871 512.335L875.613 455.277C842.332 438.408 828.42 445.201 791.288 441.173C747.87 459.682 724.662 477.614 685.954 527.493L609.301 634.042L719.3 672.554L838.875 684.401Z" fill="currentColor"/>
                      <path d="M633.551 876.431C648.671 908.629 662.802 902.957 698.928 921.458C751.214 940.435 778.511 946.098 837.423 957.823L858.536 845.541C863.402 808.225 852.564 796.654 844.24 759.324C812.915 722.431 788.698 705.048 729.738 681.868L605.75 638.226L605.698 756.545L633.551 876.431Z" fill="currentColor"/>
                    ...
                    <p style="color: var(--text-soft); font-size: 0.8rem; font-style: italic; text-align: center;">Loading purchase history...</p>
                  </div>
                </div>
              </div>
            </div>
...
async function injectStorefrontCatalogOnDetails() {
  ...
  discoverSection.innerHTML = `
    ...
    <div class="products-grid" id="detailStorefrontGrid">
      <div style="grid-column: 1/-1; text-align: center; padding: 3rem;">
        <svg class="logo-loader" viewBox="0 0 1200 1200" fill="none" xmlns="http://www.w3.org/2000/svg" style="width: 48px; height: 48px; margin: 0 auto 1.2rem;">
          <path d="M428.393 458.741C397.367 442.352 389.639 455.699 350.257 463.372C297.897 480.729 273.085 493.192 219.832 520.489L270.021 623.63C288.39 656.569 303.786 659.091 332.525 683.826C379.073 693.884 408.435 692.732 468.538 674.586L591.894 632.338L521.57 537.477L428.393 458.741Z" fill="currentColor"/>
          <path d="M573.217 875.61C558.753 907.579 544.465 901.772 508.648 919.854C456.64 938.242 429.398 943.607 370.592 954.689L347.01 842.436C341.328 805.152 351.945 793.721 359.486 756.56C390.094 720.077 413.996 702.986 472.604 680.474L595.96 638.226L598.559 756.283L573.217 875.61Z" fill="currentColor"/>
          <path d="M838.875 684.401C873.212 680.144 872.05 664.541 899.764 635.376C932.621 590.63 945.829 565.89 973.871 512.335L875.613 455.277C842.332 438.408 828.42 445.201 791.288 441.173C747.87 459.682 724.662 477.614 685.954 527.493L609.301 634.042L719.3 672.554L838.875 684.401Z" fill="currentColor"/>
          <path d="M633.551 876.431C648.671 908.629 662.802 902.957 698.928 921.458C751.214 940.435 778.511 946.098 837.423 957.823L858.536 845.541C863.402 808.225 852.564 796.654 844.24 759.324C812.915 722.431 788.698 705.048 729.738 681.868L605.75 638.226L605.698 756.545L633.551 876.431Z" fill="currentColor"/>
        ...
        <p style="color: var(--sage); font-size: 0.85rem; letter-spacing: 0.05em;">Loading storefront...</p>
      </div>
    </div>
  `;
  ...
  const renderList = (prods) => {
    ...
    const classifyProductTypeForRecs = (title, desc) => {
      const t = (title || '').toLowerCase();
      const d = (desc || '').toLowerCase();
      if (t.includes('shampoo') || t.includes('conditioner') || t.includes('hair wash') || t.includes('hair treatment') || t.includes('scalp') || t.includes('hair mask') || t.includes('hair oil') || t.includes('hair serum')) return 'Hair Care';
      if (t.includes('body wash') || t.includes('shower gel') || t.includes('body cleanser') || t.includes('shower cream')) return 'Body Wash';
      if (t.includes('body cream') || t.includes('body lotion') || t.includes('body milk') || t.includes('body butter') || t.includes('body moisturizer') || t.includes('hand cream') || t.includes('foot cream')) return 'Body Care';
      if (t.includes('sunscreen') || t.includes('sun cream') || t.includes('sunblock') || t.includes('sun gel') || t.includes('sun stick') || t.includes('sun fluid')) return 'Sunscreen';
      if (t.includes('cleansing oil') || t.includes('oil cleanser') || t.includes('cleansing balm') || t.includes('micellar') || t.includes('makeup remover') || t.includes('remover') || t.includes('cleansing water')) return 'Oil Cleanser';
      if (t.includes('exfoliat') || t.includes('scrub') || t.includes('peeling') || t.includes('peel gel') || t.includes('aha') || t.includes('bha') || t.includes('glycolic')) return 'Exfoliator';
      if (t.includes('facewash') || t.includes('face wash') || t.includes('foam cleanser') || t.includes('cleansing foam') || t.includes('foaming') || t.includes('gel cleanser') || t.includes('gentle cleanser') || t.includes('cleansing gel') || (t.includes('cleanser') && !t.includes('oil') && !t.includes('balm'))) return 'Cleanser';
      if (t.includes('toner') || t.includes('tonique') || t.includes('skin refiner') || t.includes('toning') || t.includes('first treatment')) return 'Toner';
      if (t.includes('essence') || t.includes('first essence') || t.includes('treatment essence') || t.includes('mucin') || t.includes('snail')) return 'Essence';
      if (t.includes('serum') || t.includes('ampoule') || t.includes('booster') || t.includes('concentrate')) return 'Serum';
      if (t.includes('eye cream') || t.includes('eye serum') || t.includes('eye treatment') || t.includes('eye patch') || t.includes('under eye') || t.includes('eye mask')) return 'Eye Care';
      if (t.includes('lip balm') || t.includes('lip mask') || t.includes('lip treatment') || t.includes('lip sleeping') || t.includes('lip care')) return 'Lip Care';
      if (t.includes('pimple') || t.includes('acne patch') || t.includes('spot treatment') || t.includes('blemish') || t.includes('spot gel') || t.includes('cica patch')) return 'Spot Treatment';
      if (t.includes('mist') || t.includes('face mist') || t.includes('facial spray') || t.includes('setting spray')) return 'Mist';
      if (t.includes('sleeping mask') || t.includes('sleeping pack') || t.includes('overnight mask') || t.includes('night mask')) return 'Sleeping Mask';
      if (t.includes('sheet mask') || t.includes('face mask') || t.includes('facial mask') || t.includes('mask pack')) return 'Sheet Mask';
      if (t.includes('wash-off') || t.includes('wash off') || t.includes('clay mask') || t.includes('mud mask') || t.includes('peel-off')) return 'Wash-off Mask';
      if (t.includes('bb cream') || t.includes('cc cream') || t.includes('cushion') || t.includes('foundation') || t.includes('tone up')) return 'BB & CC Cream';
      if (t.includes('retinol') || t.includes('retinal') || t.includes('retinoid') || t.includes('bakuchiol')) return 'Retinol';
      if (t.includes('lotion') || t.includes('emulsion')) return 'Lotion';
      if (t.includes('cream') || t.includes('gel cream') || t.includes('moisturizer') || t.includes('moisturising') || t.includes('soothing cream') || t.includes('water gel') || t.includes('balm') || t.includes('cica cream')) return 'Moisturizer';
      
      if (d.includes('shampoo') || d.includes('conditioner') || d.includes('hair')) return 'Hair Care';
      if (d.includes('body wash') || d.includes('shower gel')) return 'Body Wash';
      if (d.includes('body cream') || d.includes('body lotion') || d.includes('hand cream')) return 'Body Care';
      if (d.includes('sunscreen') || d.includes('sun cream') || d.includes('spf')) return 'Sunscreen';
      if (d.includes('cleansing oil') || d.includes('cleansing balm') || d.includes('makeup remover')) return 'Oil Cleanser';
      if (d.includes('exfoliat') || d.includes('scrub') || d.includes('peeling')) return 'Exfoliator';
      if (d.includes('facewash') || d.includes('face wash') || d.includes('cleansing foam') || d.includes('cleanser')) return 'Cleanser';
      if (d.includes('toner') || d.includes('toning')) return 'Toner';
      if (d.includes('essence') || d.includes('mucin') || d.includes('snail')) return 'Essence';
      if (d.includes('serum') || d.includes('ampoule') || d.includes('booster')) return 'Serum';
      if (d.includes('eye cream') || d.includes('eye serum')) return 'Eye Care';
      if (d.includes('lip balm') || d.includes('lip mask')) return 'Lip Care';
      if (d.includes('pimple') || d.includes('acne patch') || d.includes('blemish')) return 'Spot Treatment';
      if (d.includes('mist') || d.includes('facial spray')) return 'Mist';
      if (d.includes('sleeping mask') || d.includes('sleeping pack') || d.includes('overnight')) return 'Sleeping Mask';
      if (d.includes('sheet mask') || d.includes('face mask') || d.includes('mask pack')) return 'Sheet Mask';
      if (d.includes('wash-off') || d.includes('clay mask') || d.includes('mud mask')) return 'Wash-off Mask';
      if (d.includes('bb cream') || d.includes('cc cream') || d.includes('cushion') || d.includes('tone up')) return 'BB & CC Cream';
      if (d.includes('retinol') || d.includes('retinal') || d.includes('bakuchiol')) return 'Retinol';
      if (d.includes('lotion') || d.includes('emulsion')) return 'Lotion';
      if (d.includes('cream') || d.includes('moisturizer') || d.includes('gel cream')) return 'Moisturizer';
      return 'Other';
    };
